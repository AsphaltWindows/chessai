...
print("Selfplay directory: " + selfplay_dir)
...
resultsFile = open(selfplay_dir + "/results.txt", "a")

at_round = 0

while at_round < round_num:

    game_dir = os.path.join(selfplay_dir, "round" + str(at_round))
