...
cnb_clas_t * create_cnb_with_alpha(uint8_t class_num, const uint8_t * cats, size_t cat_num, double alpha);

cnb_clas_t * create_cnb(uint8_t class_num, const uint8_t * cats, size_t cat_num);
